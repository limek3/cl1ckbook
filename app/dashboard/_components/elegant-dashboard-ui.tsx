    ...
    <Card className={cn('overflow-hidden p-5', dark && 'border-[#0d2a50] bg-[#071c39] text-white shadow-[0_26px_70px_rgba(7,28,57,0.22)]')}>
      <div className="flex items-start justify-between gap-5">
        <div>
          ...
          <div className={cn('mt-3 text-[30px] font-semibold tracking-[-0.05em]', dark ? 'text-white' : 'text-[#071c39]')}>{value}</div>
  ...
  return (
    <div className="relative grid place-items-center" style={{ width: size, height: size }}>
      ...
      <div className="absolute text-center">
        <div className="text-[28px] font-semibold tracking-[-0.05em] text-[#071c39]">{value}%</div>
