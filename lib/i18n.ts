...
export const messages = {
  ru: {
    ...
    publicPage: {
      ...
      bookBlockDescription: 'Оставьте заявку здесь — специалист увидит её в кабинете и подтвердит запись.',
    },
    statuses: {
      new: 'Новая',
  ...
  en: {
    ...
    bookingForm: {
      ...
      successDescription: 'The specialist will contact you and confirm the booking in your preferred channel.',
    ...
    publicPage: {
      ...
      bookBlockDescription: 'Submit a request here — the specialist will see it in the workspace and confirm the booking.',
    },
    statuses: {
      new: 'New',
      confirmed: 'Confirmed',
