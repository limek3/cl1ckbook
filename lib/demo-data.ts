...
export const demoProfile: MasterProfile = {
  ...
  name: 'Алина Морозова',
  profession: 'Ногтевой сервис · демо-режим',
  city: 'Москва',
  bio: 'Аккуратная демонстрационная страница с отзывами, работами и понятной онлайн-записью. Здесь можно посмотреть, как выглядит профиль мастера и путь клиента до записи.' ,
  services: [
    'Маникюр + покрытие',
    'Укрепление гелем',
    'Смарт-педикюр',
  ...
  reviews: [
    ...
    },
    {
      ...
      author: 'Елена',
      rating: 5,
      text: 'Страница выглядит аккуратно и сразу показывает, как будет устроена запись после запуска.',
