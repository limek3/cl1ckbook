...
const createWorkImage = (accentA: string, accentB: string, label: string) =>
  `data:image/svg+xml;utf8,${encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" width="640" height="480" viewBox="0 0 640 480">
      ...
      <text x="112" y="384" font-family="Arial, Helvetica, sans-serif" font-size="24" fill="white">${label}</text>
    </svg>`,
  )}`;
...
export const demoMasterProfile: MasterProfile = {
  ...
  city: 'Амстердам',
  bio: 'Аккуратный маникюр, стойкое покрытие и спокойный сервис без длинной переписки. На странице сразу видно услуги, отзывы, ближайшие даты и быстрый путь записи — клиенту не нужно гадать, что делать дальше.',
  services: [
  ...
  reviews: [
    ...
    },
    {
      ...
      author: 'Екатерина',
      rating: 5,
      text: 'Понравилось, что на странице сразу видно услуги, свободные даты и контакты. Всё спокойно, без лишних шагов.',
    ...
    },
    {
      ...
      author: 'София',
      rating: 4,
      text: 'Чисто, спокойно и очень понятно по сервису. Подтверждение пришло быстро, мастер заранее уточнила нюансы.',
