...
function readStoredDemoProfile() {
    ...
    try {
        ...
        return raw ? normalizeDemoProfile(JSON.parse(raw)) : null;
    } catch  {
        return null;
    }
}
function saveStoredDemoProfile(profile) {
    ...
    try {
        ...
        window.dispatchEvent(new CustomEvent(DEMO_PROFILE_UPDATED_EVENT, {
            detail: normalized
        }));
    } catch  {}
}
...
function getDashboardDemoAppearance() {
    return {
        ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$appearance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultAppearanceSettings"],
        accentTone: 'cobalt',
        neutralTone: 'zinc',
        density: 'compact',
        radius: 'medium',
...
//# sourceMappingURL=_0f82e4c2._.js.map